               ...
               <div class="row g-3">
                ...
                <div class="col-12">
                 ...
                 <div class="input-group">
                      ...
                      {
                        errors.mobile && <div class="invalid-feedback">
                ...
                <div class="col-12">
                      ...
                      <input type="email" class="form-control" id="email" {...register('mobile',{required:true})} placeholder="abc@gmail.com"/>
                      {
...
function Checkout(){
  ...
  <div class="row g-4">
    <div class="col-md-5 col-lg-4 order-md-last">
      <h4 class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-primary">Your cart</span>
        <span class="badge badge-secondary rounded-pill">{cartItem}</span>
      </h4>
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between">
    ...
    <div class="col-md-7 col-md-8">
      <h4 class="mb-3">Billing address</h4>
        ...
        <div class="col-12">
          ...
          <input type="email" class="form-control" id="email" {...register('email',{required:true})} placeholder="you@example.com" required/>
          {errors.email && <div class="text-danger">
          Please enter a valid email address for shipping updates.
            </div>}
        ...
        <div class="col-md-5">
            <label for="country">Country</label>
            <select class="form-select"  value="india" id="country" {...register('landmark',{required:true})} required>
          ...
          <div class="col-md-4">
            ...
            Please select a valid this state.
                </div>}
